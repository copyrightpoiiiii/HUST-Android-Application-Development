...
import com.example.desktoppet.bluetoothStatus;
...
public class bluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(bluetoothStatus.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(bluetoothStatus.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(bluetoothStatus.DEVICE_NAME, device.getName());
        bundle.putString(bluetoothStatus.DEVICE_ADDRESS, device.getAddress());
        msg.setData(bundle);
            ...
            while (mState != bluetoothStatus.STATE_CONNECTED && isRunning) {
                ...
                if (socket != null) {
                    synchronized (bluetoothService.this) {
                        switch (mState) {
                            case bluetoothStatus.STATE_LISTEN:
                            case bluetoothStatus.STATE_CONNECTING:
                                // Situation normal. Start the connected thread.
                                connected(socket, socket.getRemoteDevice(),
                                        mSocketType);
                                break;
                            case bluetoothStatus.STATE_NONE:
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if(data == 0x0A) {
                        ...
                        mHandler.obtainMessage(bluetoothStatus.MESSAGE_READ
        ...
        public void write(byte[] buffer) {
            try {/*
                ...
                mHandler.obtainMessage(bluetoothStatus.MESSAGE_WRITE
